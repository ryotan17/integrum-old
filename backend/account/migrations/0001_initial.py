    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='created at')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='updated at')),
                ('company', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='groups', to='account.Company')),
            ],
        ),
        migrations.AddField(
            model_name='user',
            name='admin_group',
            field=models.ManyToManyField(blank=True, related_name='admin_users', to='account.Group'),
        ),
        migrations.AddField(
            model_name='user',
            name='group',
            field=models.ManyToManyField(blank=True, related_name='users', to='account.Group'),
        ),
        migrations.AddField(
            model_name='user',
            name='groups',
